...
macro(find_gradle)
  find_file(
    ${PROJECT_NAME}_gradle_BINARY gradlew
    PATHS
...
macro(find_gradle_repo_root)
  find_file(
    ${PROJECT_NAME}_gradle_SETTINGS settings.gradle
    PATHS
    ${CMAKE_CURRENT_SOURCE_DIR}
    ${CMAKE_CURRENT_SOURCE_DIR}/..
    ${CMAKE_CURRENT_SOURCE_DIR}/../..
...
# containing mobile_catkin_modules_build_development_tools to be built as well. In this situtation
...
macro(catkin_mobile_catkin_modules_build_development_tools_env_setup)
  ...
  if(NOT ROS_MAVEN_REPOSITORY)
    list(APPEND ROSMOBILE_ENV "ROS_MAVEN_REPOSITORY=https://github.com/mobile_catkin_modules_build_development_tools/mobile_catkin_modules_build_development_tools_mvn_repo/raw/master")
  else()
...
macro(catkin_mobile_catkin_modules_build_development_tools_setup)
  catkin_mobile_catkin_modules_build_development_tools_env_setup()
  find_gradle()
  if(${ARGC} EQUAL 0)
